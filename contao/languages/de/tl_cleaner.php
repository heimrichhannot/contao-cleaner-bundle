...
$lang['addMaxAge'] = ['Mindestalter hinzufügen', 'Wählen Sie diese Option, um neuere Entitäten vor dem Löschen zu schützen.'];
$lang['maxAge'] = ['Mindestalter', 'Wählen Sie hier aus, ab welchem Mindestalter ein Datensatz als inaktiv gilt, und gelöscht werden kann.'];
$lang['maxAge']['m'] = 'Minute(n)';
$lang['maxAge']['h'] = 'Stunde(n)';
$lang['maxAge']['d'] = 'Tag(e)';
$lang['maxAge']['w'] = 'Woche(n)';
$lang['maxAge']['M'] = 'Monat(e)';
$lang['maxAge']['y'] = 'Jahr(e)';
$lang['maxAgeField'] = ['Feld mit Datensatzalter', 'Geben Sie hier den Namen des Feldes an, welches das Alter des Datensatzes widerspiegelt.'];
$lang['period'] = ['Zeitintervall', 'Wählen Sie hier, wie oft die Säuberung ausgeführt werden soll. Dabei wird Contao\'s Poor Man\'s Cron (TL_CRON) verwendet.'];
