 ...
 */
$arrLang['reference'] = [
    \HeimrichHannot\CleanerBundle\Command\Cleaner::TYPE_ENTITY                          => 'Entität',
    \HeimrichHannot\CleanerBundle\Command\Cleaner::TYPE_FILE                            => 'Datei',
    \HeimrichHannot\CleanerBundle\Command\Cleaner::FILEDIR_RETRIEVAL_MODE_ENTITY_FIELDS => 'Felder von Entitäten',
    \HeimrichHannot\CleanerBundle\Command\Cleaner::FILEDIR_RETRIEVAL_MODE_DIRECTORY     => 'Verzeichnis',
];
