...
$GLOBALS['TL_DCA']['tl_cleaner'] = [
    ...
    'palettes'    => [
        ...
        \HeimrichHannot\CleanerBundle\Cron\Cleaner::TYPE_ENTITY => '{general_legend},type,title;{config_legend},dataContainer,period,whereCondition,addMaxAge;{publish_legend},published;',
        \HeimrichHannot\CleanerBundle\Cron\Cleaner::TYPE_FILE   => '{general_legend},type,title;{config_legend},period,fileDirRetrievalMode;{publish_legend},published;',
    ],
    'subpalettes' => [
        'addMaxAge'                                                                                                => 'maxAge,maxAgeField',
        'fileDirRetrievalMode_' . \HeimrichHannot\CleanerBundle\Cron\Cleaner::FILEDIR_RETRIEVAL_MODE_ENTITY_FIELDS => 'dataContainer,entityFields,whereCondition,addMaxAge',
        'fileDirRetrievalMode_' . \HeimrichHannot\CleanerBundle\Cron\Cleaner::FILEDIR_RETRIEVAL_MODE_DIRECTORY     => 'directory,addGitKeepAfterClean',
    ],
    'fields'      => [
        'id'                   => [
        ...
        'type'                 => [
            ...
            'filter'    => true,
            'inputType' => 'select',
            'options'   => \HeimrichHannot\CleanerBundle\Cron\Cleaner::TYPES,
        ...
        'fileDirRetrievalMode' => [
            ...
            'filter'    => true,
            'inputType' => 'select',
            'options'   => \HeimrichHannot\CleanerBundle\Cron\Cleaner::FILEDIR_RETRIEVAL_MODES,
            'reference' => &$GLOBALS['TL_LANG']['tl_cleaner']['reference'],
